...
class QBBuffer extends Uint8Array {
  static override from(value: string | ArrayBuffer | SharedArrayBuffer | Uint8Array | ArrayLike<number>, encodingOrOffset?: string | number, length?: number): QBBuffer {
    ...
    if (typeof value === "object" && "type" in value && (value as { type: unknown }).type === "Buffer") {
  ...
  static allocUnsafe(size: number): QBBuffer { return new QBBuffer(size); }

  static isBuffer(obj: unknown): obj is QBBuffer { return obj instanceof QBBuffer; }

  static isEncoding(encoding: string): boolean {
    try { normalizeEncoding(encoding); return true; } catch { return false; }
  }
  ...
  write(string: string, offsetOrEncoding?: number | string, lengthOrEncoding?: number | string, encoding?: string): number {
    let off = 0;
  ...
  override slice(start?: number, end?: number): QBBuffer { return wrapBuffer(super.subarray(start, end)); }
  override subarray(start?: number, end?: number): QBBuffer { return wrapBuffer(super.subarray(start, end)); }
  ...
  lastIndexOf(value: number | string | Uint8Array, byteOffset?: number, encoding?: string): number {
    ...
    if (typeof value === "number") {
      for (let i = Math.min(maxOffset, this.length - 1); i >= 0; i--) if (this[i] === (value & 0xff)) return i;
      return -1;
    }
    const needle = typeof value === "string" ? encodeString(value, normalizeEncoding(encoding)) : value;
  ...
  override fill(value: string | number | Uint8Array, offset?: number, end?: number, encoding?: string): this {
    const off = offset ?? 0;
    const e = end ?? this.length;
    if (typeof value === "number") { super.fill(value & 0xff, off, e); return this; }
    if (typeof value === "string") {
  ...
  swap16(): this {
    ...
    for (let i = 0; i < this.length; i += 2) { const a = this[i]; this[i] = this[i + 1]; this[i + 1] = a; }
    return this;
  }
  ...
  private dv(): DataView { return new DataView(this.buffer, this.byteOffset, this.byteLength); }

  readUInt8(offset = 0): number { return this[offset]; }
  readUInt16BE(offset = 0): number { return (this[offset] << 8) | this[offset + 1]; }
  readUInt16LE(offset = 0): number { return this[offset] | (this[offset + 1] << 8); }
  readUInt32BE(offset = 0): number { return (this[offset] * 0x1000000 + ((this[offset + 1] << 16) | (this[offset + 2] << 8) | this[offset + 3])) >>> 0; }
  readUInt32LE(offset = 0): number { return (this[offset] | (this[offset + 1] << 8) | (this[offset + 2] << 16) | (this[offset + 3] * 0x1000000)) >>> 0; }
  readInt8(offset = 0): number { const v = this[offset]; return v & 0x80 ? v - 0x100 : v; }
  readInt16BE(offset = 0): number { const v = (this[offset] << 8) | this[offset + 1]; return v & 0x8000 ? v - 0x10000 : v; }
  readInt16LE(offset = 0): number { const v = this[offset] | (this[offset + 1] << 8); return v & 0x8000 ? v - 0x10000 : v; }
  readInt32BE(offset = 0): number { return (this[offset] << 24) | (this[offset + 1] << 16) | (this[offset + 2] << 8) | this[offset + 3]; }
  readInt32LE(offset = 0): number { return this[offset] | (this[offset + 1] << 8) | (this[offset + 2] << 16) | (this[offset + 3] << 24); }
  readFloatBE(offset = 0): number { return this.dv().getFloat32(offset, false); }
  readFloatLE(offset = 0): number { return this.dv().getFloat32(offset, true); }
  readDoubleBE(offset = 0): number { return this.dv().getFloat64(offset, false); }
  readDoubleLE(offset = 0): number { return this.dv().getFloat64(offset, true); }
  readBigInt64BE(offset = 0): bigint { return this.dv().getBigInt64(offset, false); }
  readBigInt64LE(offset = 0): bigint { return this.dv().getBigInt64(offset, true); }
  readBigUInt64BE(offset = 0): bigint { return this.dv().getBigUint64(offset, false); }
  readBigUInt64LE(offset = 0): bigint { return this.dv().getBigUint64(offset, true); }

  writeUInt8(value: number, offset = 0): number { this[offset] = value & 0xff; return offset + 1; }
  writeUInt16BE(value: number, offset = 0): number { this[offset] = (value >>> 8) & 0xff; this[offset + 1] = value & 0xff; return offset + 2; }
  writeUInt16LE(value: number, offset = 0): number { this[offset] = value & 0xff; this[offset + 1] = (value >>> 8) & 0xff; return offset + 2; }
  writeUInt32BE(value: number, offset = 0): number { this[offset] = (value >>> 24) & 0xff; this[offset + 1] = (value >>> 16) & 0xff; this[offset + 2] = (value >>> 8) & 0xff; this[offset + 3] = value & 0xff; return offset + 4; }
  writeUInt32LE(value: number, offset = 0): number { this[offset] = value & 0xff; this[offset + 1] = (value >>> 8) & 0xff; this[offset + 2] = (value >>> 16) & 0xff; this[offset + 3] = (value >>> 24) & 0xff; return offset + 4; }
  writeInt8(value: number, offset = 0): number { this[offset] = value & 0xff; return offset + 1; }
  writeInt16BE(value: number, offset = 0): number { this[offset] = (value >>> 8) & 0xff; this[offset + 1] = value & 0xff; return offset + 2; }
  writeInt16LE(value: number, offset = 0): number { this[offset] = value & 0xff; this[offset + 1] = (value >>> 8) & 0xff; return offset + 2; }
  writeInt32BE(value: number, offset = 0): number { this[offset] = (value >>> 24) & 0xff; this[offset + 1] = (value >>> 16) & 0xff; this[offset + 2] = (value >>> 8) & 0xff; this[offset + 3] = value & 0xff; return offset + 4; }
  writeInt32LE(value: number, offset = 0): number { this[offset] = value & 0xff; this[offset + 1] = (value >>> 8) & 0xff; this[offset + 2] = (value >>> 16) & 0xff; this[offset + 3] = (value >>> 24) & 0xff; return offset + 4; }
  writeFloatBE(value: number, offset = 0): number { this.dv().setFloat32(offset, value, false); return offset + 4; }
  writeFloatLE(value: number, offset = 0): number { this.dv().setFloat32(offset, value, true); return offset + 4; }
  writeDoubleBE(value: number, offset = 0): number { this.dv().setFloat64(offset, value, false); return offset + 8; }
  writeDoubleLE(value: number, offset = 0): number { this.dv().setFloat64(offset, value, true); return offset + 8; }
  writeBigInt64BE(value: bigint, offset = 0): number { this.dv().setBigInt64(offset, value, false); return offset + 8; }
  writeBigInt64LE(value: bigint, offset = 0): number { this.dv().setBigInt64(offset, value, true); return offset + 8; }
  writeBigUInt64BE(value: bigint, offset = 0): number { this.dv().setBigUint64(offset, value, false); return offset + 8; }
  writeBigUInt64LE(value: bigint, offset = 0): number { this.dv().setBigUint64(offset, value, true); return offset + 8; }
}
